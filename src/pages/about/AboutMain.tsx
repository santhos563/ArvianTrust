...
const About = () => {
    ...
    const cards = t('about.work.cards', { returnObjects: true }) as Array<{ title: string; description: string }>;
            ...
            <div className="bg-[#f0f9f7] py-20 border-b border-[#145A4A]/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p
                        ...
                        style={{ fontFamily: "'Inter', sans-serif" }}
                        dangerouslySetInnerHTML={{ __html: t('about.header.description') }}
                    />
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 items-start">
                        ...
                        <div className="md:sticky md:top-24">
                            <div className="relative rounded-2xl overflow-hidden h-140 shadow-2xl">
                                <img
                                    src={book}
                                    alt="Children studying in classroom"
                                    className="absolute inset-0 w-full h-full object-cover"
                                />
                                <div className="absolute inset-0 bg-linear-to-t from-[#145A4A] via-[#145A4A]/65 to-transparent" />
                                <div className="absolute bottom-0 left-0 p-8 text-white">
                                    <span
                                        className="text-[#C46A2D] font-semibold text-xs uppercase tracking-[0.2em] mb-3 block"
                                        style={{ fontFamily: "'Inter', sans-serif" }}
                                    >
                                        {t('about.work.image.caption')}
                                    </span>
                                    <h4
                                        className="text-3xl md:text-4xl font-bold mb-3 leading-tight"
                                        style={{ fontFamily: "'Playfair Display', serif" }}
                                    >
                                        {t('about.work.image.heading')}
                                    </h4>
                                    ...
                                    <p
                                        ...
                                        style={{ fontFamily: "'Inter', sans-serif" }}
                                    >
                                        {t('about.work.image.description')}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            {cards.map((c, idx) => (
                                <div
                                    ...
                                    style={{ borderLeftColor: idx < 3 ? "#145A4A" : "#C46A2D" }}
                                >
                                    <div className="flex items-start gap-4">
                                        <div
                                            ...
                                            style={{ backgroundColor: idx < 3 ? "#145A4A" : "#C46A2D" }}
                                        >
                                            {idx === 0 && (
                                            ...
                                            {idx === 2 && (
                                                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2 2 2 4-4 2 2 4-4 2 2 2-2M5 12v6h14v-6" />
                                                </svg>
                                            )}
                                            {idx === 3 && (
                                                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
