    ...
    const cards = [
        {
            ...
            titleKey: "about.work.cards.0.title",
            descKey: "about.work.cards.0.description",
        },
        {
            border: "#145A4A",
            icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z",
            titleKey: "about.work.cards.1.title",
            descKey: "about.work.cards.1.description",
        },
        {
            border: "#145A4A",
            icon: "M3 12l2-2 2 2 4-4 2 2 4-4 2 2 2-2M5 12v6h14v-6",
            titleKey: "about.work.cards.2.title",
            descKey: "about.work.cards.2.description",
        },
        {
            border: "#C46A2D",
            icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",
            titleKey: "about.work.cards.3.title",
            descKey: "about.work.cards.3.description",
        },
        {
            border: "#C46A2D",
            icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
            titleKey: "about.work.cards.4.title",
            descKey: "about.work.cards.4.description",
        },
    ];
                            ...
                            <div className="relative rounded-2xl overflow-hidden h-[560px] shadow-2xl">
                                ...
                                <div className="absolute bottom-0 left-0 p-8 text-white">
                                    ...
                                    <h4
                                        ...
                                        style={{ fontFamily: "'Playfair Display', serif" }}
                                        dangerouslySetInnerHTML={{ __html: t('about.work.image.heading') }}
                                    />
